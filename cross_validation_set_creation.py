...
print("==============================================")
print("STATISTICS (CROSS_VALIDATION SET):")
print("----------------------------------------------")
...
title =     "Distribution of spam and ham (non-spam) emails in cross-validation set"

class_labels_train = ["ham", "spam"]
class_counts_train = [total_hams, total_spams]

file_dir = "resources"
file_name = "spam_ham_distribution_cross_validation_set.pdf"
...
f = open("resources/cross_validation_set.csv", "w+")
...
print(
    "Total time (in seconds) taken to create cross-validation set: " + \
